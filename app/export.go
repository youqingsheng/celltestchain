...
func (app *CellApp) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string,
...
func (app *CellApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
